        ...
        do {
            ...
            switch (tokens[0]) {
                ...
                case "add_route":
                    ...
                    break;
                case "add_bus":
                    int busID = martaModel.makeVehicle(tokens[1], Integer.parseInt(tokens[2]), Integer.parseInt(tokens[3]), Integer.parseInt(tokens[4]), Integer.parseInt(tokens[5]), Integer.parseInt(tokens[6]), Integer.parseInt(tokens[7]));
                ...
                case "system_report":
                    ...
                    for (Vehicle singleBus: martaModel.getVehicles().values()) { singleBus.displayInternalStatus(); }
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (int i = 0; i < busesOnRoute; i++) {
                    //martaModel.makeVehicle(busID, routeID, startingPosition + i * skip, 0, 10, 1);
